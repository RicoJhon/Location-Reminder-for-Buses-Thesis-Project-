...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Marker mCurrent, reminderMarker;
    ...
    public static final String SWITCH = "locationSwitch";
    ...
    private Boolean restoreNavigate() {
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, Context.MODE_PRIVATE);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot childDs : dataSnapshot.getChildren()) {
                    ...
                    mMap.addCircle(new CircleOptions()
                            ...
                            .strokeWidth(5.0f));
                    geoService.startService(location, proximityRadius);
                }
            }
